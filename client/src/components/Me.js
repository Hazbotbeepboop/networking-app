        ...
        {selectedConversation ? (
          ...
          <div className="space-y-2">
            {conversations.length === 0 && (
              <div className="space-y-3">
                <p className="text-xs text-gray-400 leading-relaxed">Your private space for goals, reflections, and context about yourself. Varys draws on your journal when giving advice — the more it knows about where you're headed, the more specific it can be.</p>
                <div className="border border-dashed border-gray-200 rounded-lg p-3 opacity-50 pointer-events-none select-none">
                  ...
                  <div className="text-xs text-gray-400 leading-relaxed line-clamp-3">I want to move into more consulting work and less of the day-to-day grind. A few interesting conversations lately but nothing concrete yet — I need to be more deliberate about who I spend time with and what opportunities I actually say yes to.</div>
                </div>
              </div>
            )}
